...
void Scene::initScene() {
    ...
    // floor
    plane_material.setColor(Color( 0.4f, 0.3f, 0.3f ));
...
//    plane_material.setDiffusion(0.5f);
    ...
    sphere_material.setRefraction(0.0f);
    sphere_material.setReflection(0.5f);
...
//    object_list.push_back(new Sphere(sphere_material, "small sphere", false, VecF(30, 0, 30), 0.5f));
    ...
    object_list.push_back(new Sphere(light_material, "light 1", true, VecF(0, 5, 5), 0.1f));
    // light source 2
